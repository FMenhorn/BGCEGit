...
Parametrised geometries are often given in terms of NURBS descriptions (e.g. in FreeCAD software). %REFERENCE.  
To define NURBS from a mathematical standpoint, we first define so-called \textit{Bezier curves} which we will use later for the definition of NURBS.
