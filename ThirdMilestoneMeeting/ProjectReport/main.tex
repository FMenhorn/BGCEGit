...
\documentclass[11pt, a4paper, bibtotoc, idxtotoc, headsepline, footsepline, footexclude, DIV13, oneside, final]{scrbook}
...
\begin{comment}	
\cleardoublepage
\printacronyms[	include-classes=abbrev, name=Abbreviations, sort = true]
\printacronyms[	include-classes=nomencl, name=Nomenclature, sort = true]
\end{comment}
