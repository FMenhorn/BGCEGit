...
\foreach \i in {0,..., 4}
{
	\foreach \j in {0,..., 4}
	{
		\coordinate(Ao \i \j) at ($(patchABase) + \i*(1,0,-0.2)+\j*(0,1,-0.4)$);
		\coordinate(A \i \j) at ($(Ao \i \j) + (upshiftSurface) + \i*(1,0,-0.2)+\j*(0,1,-0.4) - {(\i*(\i-4) + \j*(\j-4))}*(0,0,0.25)$);				
	}
}	
...
\foreach \i in {0.1,0.2,..., 4}
{
	...
	{			
		\draw[thick,blue] 
		($(patchABaseUp) + {(\i-0.1)}*(1,0,-0.2)+\j*(0,1,-0.4) - {((\i-0.1)*(\i-0.1-4) + \j*(\j-4))}*(0,0,0.25)$) 
		-- 
		($(patchABaseUp) + \i*(1,0,-0.2)+\j*(0,1,-0.4) - {(\i*(\i-4) + \j*(\j-4))}*(0,0,0.25)$);	
		\draw[very thin] 
		($(patchABase) + {(\i-0.1)}*(1,0,-0.2)+\j*(0,1,-0.4)$) 
		-- 
		($(patchABase) + \i*(1,0,-0.2)+\j*(0,1,-0.4)$);
	}
}
...
\foreach \i in {0,..., 4}
{
	...
	{		
		\draw[thick,blue] 
		($(patchABaseUp) + \i*(1,0,-0.2)+{(\j-0.1)}*(0,1,-0.4) - {(\i*(\i-4) + (\j-0.1)*(\j-0.1-4))}*(0,0,0.25)$) 
		-- 
		($(patchABaseUp) + \i*(1,0,-0.2)+\j*(0,1,-0.4) - {(\i*(\i-4) + \j*(\j-4))}*(0,0,0.25)$);
		\draw[very thin] 
		($(patchABase) + \i*(1,0,-0.2)+{(\j-0.1)}*(0,1,-0.4)$) 
		-- 
		($(patchABase) + \i*(1,0,-0.2)+\j*(0,1,-0.4)$);						
	}
}
...
{
-- ($(patchABaseUp) + \i*(1,0,-0.2) - {\i*(\i-4)}*(0,0,0.25)$)
}
\foreach \j in {0,0.1,..., 4}
{
-- ($(patchABaseUp) + 4*(1,0,-0.2)+\j*(0,1,-0.4) - {\j*(\j-4)}*(0,0,0.25)$)
}
\foreach \i in {4,3.9,..., 0}
{
-- ($(patchABaseUp) + \i*(1,0,-0.2)+4*(0,1,-0.4) - {\i*(\i-4)}*(0,0,0.25)$)
}
\foreach \j in {4,3.9,..., .1}
{
-- ($(patchABaseUp) + \j*(0,1,-0.4) - {\j*(\j-4)}*(0,0,0.25)$)
};
...
\foreach \i in {0,..., 4}
{
	\foreach \j in {0,..., 4}
	{
		\coordinate(Bo \i \j) at ($(patchBBase) + \i*(1,0,-0.2)+\j*(0,1,-0.4)$);
...
\foreach \i in {0.1,0.2,..., 4}
{
	...
	{			
		\draw[very thin] 
		($(patchBBase) + {(\i-0.1)}*(1,0,-0.2)+\j*(0,1,-0.4)$) 
		-- 
		($(patchBBase) + \i*(1,0,-0.2)+\j*(0,1,-0.4)$);	
	}
}
...
\foreach \i in {0,..., 4}
{
	...
	{		
		\draw[very thin] 
		($(patchBBase) + \i*(1,0,-0.2)+{(\j-0.1)}*(0,1,-0.4)$) 
		-- 
		($(patchBBase) + \i*(1,0,-0.2)+\j*(0,1,-0.4)$);	
	}
}
...
\foreach \i in {1,1.5,2}
{
	...
	{
	\node[circle, fill=OliveGreen, draw=black,inner sep=2pt] at ($(patchBBase) + \i*(1,0,-0.2)+\j*(0,1,-0.4)$){};
	}
}
\contourlength{.15em}
\node[label={[OliveGreen,yshift=.1cm,xshift=-.1cm]below right:\contour{white}{$\vec{B}_{i,j}^{B\acute{e}z}$}}] at ($(patchBBase) + 2*(1,0,-0.2)+1.5*(0,1,-0.4)$){};
...
\foreach \i in {0,..., 4}
{
	\foreach \j in {0,..., 4}
	{
		\coordinate(Co \i \j) at ($(patchCBase) + \i*(1,0,-0.2)+\j*(0,1,-0.4)$);
...
\foreach \i in {0.1,0.2,..., 4}
{
	...
	{			
		\draw[very thin] 
		($(patchCBase) + {(\i-0.1)}*(1,0,-0.2)+\j*(0,1,-0.4)$) 
		-- 
		($(patchCBase) + \i*(1,0,-0.2)+\j*(0,1,-0.4)$);	
	}
}
...
\foreach \i in {0,..., 4}
{
	...
	{		
		\draw[very thin] 
		($(patchCBase) + \i*(1,0,-0.2)+{(\j-0.1)}*(0,1,-0.4)$) 
		-- 
		($(patchCBase) + \i*(1,0,-0.2)+\j*(0,1,-0.4)$);	
	}
}
...
\foreach \i in {0.5,1.5,2.5}
{
	...
	{
	\node[circle, fill=orange, draw=black,inner sep=2pt] at ($(patchCBase) + \i*(1,0,-0.2)+\j*(0,1,-0.4)$){};
	}
}
...
($(C 40)+(180:.5cm)$) 
to [out=210,in=-30] 
node[align=center]{Rows $\left[C^{PS}P\right]_{i,j}$ \\ give control points $\bm{p}_{i,j}$} 
($(B 40)+(0:.5cm)$);
