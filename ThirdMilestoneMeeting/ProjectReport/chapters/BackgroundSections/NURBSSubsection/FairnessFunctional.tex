...
\tododone[author=Benni,inline]{looks strange, if paragraph ends with formulas. Probably some text is still missing here? Erik: Sorry, forgot to remove. Done now.}
