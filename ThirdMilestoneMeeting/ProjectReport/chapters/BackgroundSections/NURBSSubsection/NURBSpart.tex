...
% Benni Removed this
%Analogous to the tensor product \Bez %curve surfaces, one can define tensor %product B-spline or NURBS surfaces.
\todointern[author=Benni,inline]{@ Erik: added following equation}
\todointern[author=Benni,inline]{@Erik: why subscript $m,n$ for $N_{i,n}$, but superscript $m,n$ for $b_i^n$?}
