...
\subsubsection{Fitting Problem: Fairness}
...
\todointernal[inline]{are the following two formulas really equal or is the minimization of both equivalent? The square for the second expression looks strange...}
\begin{align*}
