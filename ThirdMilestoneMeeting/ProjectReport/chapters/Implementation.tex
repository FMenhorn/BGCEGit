\chapter{CADO: Computer Aided Design Optimization Tool}
...
\todourgent[author=Benni, inline]{Add short (!) remark on GUI. No GUI explanation only picture and reference to user guide.}
