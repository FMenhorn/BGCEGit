...
\item Coarsening - the number of coarsening steps in Dual Contouring(see \todourgent{add ref to corresponding section!}).
\end{itemize}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.35]{Pictures/CADO_mainWindowParameters.png}
