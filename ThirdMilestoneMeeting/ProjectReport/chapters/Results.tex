\chapter{Results}
\todointernal[author=Benni,inline]{@ Saumi: please proofread this chapter: DONE}
...
\todointern{Saumi: Change title and move it to the top: DONE}
\label{sec:uex}
...
The first test case simulates a cantilever. A cuboidal block of material\todo{better description?} is provided as the initial condition. This block is fixed at one end to a wall. The load on the cantilever is modeled as a downward force on its other end. (see \autoref{fig:cantiBC}).
