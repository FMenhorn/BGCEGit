...
\begin{frame}
MISSING!!!
Only some blabla about freecad. Not too technical. Just use obtained control points from Peters scheme for plotting NURBS using an existing geometry kernel (in our case freecad, but also working with arbitrary other kernels)
\end{frame}
