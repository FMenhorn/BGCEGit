...
\begin{frame}{Fitting Problem: Peters’ Scheme\footnote{\textbf{Matthias Eck, Hugues Hoppe.} "Automatic Reconstruction of B-Spline Surfaces of Arbitrary Topological Type"}}
\vspace{-0.5cm}
\only<1>{
