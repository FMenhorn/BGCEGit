...
\begin{minipage}[t]{0.4\linewidth}
	...
	\only<1>{
		\begin{figure}	
			\centering
			\includegraphics[width=.6\textwidth]{Pictures/DC/MC1.png}
		\end{figure}}
	\only<2>{
		\begin{figure}	
			\centering
			\includegraphics[width=.6\textwidth]{Pictures/DC/MC2.png} 
		\end{figure}}
	\only<3>{
		\begin{figure}	
			\centering
			\includegraphics[width=.6\textwidth]{Pictures/DC/MC3.png} 
		\end{figure}}
	\only<4->{
		\begin{figure}	
			\centering
			\includegraphics[width=.6\textwidth]{Pictures/DC/MC4.png} 
			\end{figure}}
\end{minipage}%
\hfill%
\begin{minipage}[t]{0.4\linewidth}
...
\only<7>{
		\begin{figure}	
		\centering
		\includegraphics[width=.6\textwidth]{Pictures/DC/DC3.png} 
		\end{figure}}
\only<8->{
		\begin{figure}	
		\centering
		\includegraphics[width=.6\textwidth]{Pictures/DC/DC4.png} 
		\end{figure}}
\end{minipage}
\vspace{0.4cm}
