...
\item Possibly that this can used to fit the location of these "patch points" to a set of datapoints by minimusing a least-squares error \todo{stress the relation to parametrized datapoints}
\end{itemize}
\begin{figure}
