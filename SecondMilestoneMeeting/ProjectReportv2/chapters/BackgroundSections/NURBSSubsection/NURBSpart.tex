...
\end{equation*}
\\
\st{Note that Bezier curves  and surfaces may be unstable --- minor changes in control points might lead to major global changes.}\tododone{Benni: remove this sentence because we don't care.}
