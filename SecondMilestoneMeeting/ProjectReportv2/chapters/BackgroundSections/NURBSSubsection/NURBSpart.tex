...
\end{equation*}
\\
Note that Bezier curves \todo{Benni: higher-order only? Put reference here, ask Anna} and surfaces may be unstable --- minor changes in control points might lead to major global changes.
