...
\todo[inline]{Erik: define section}

\subsection{Fitting problem}
\todo[inline]{is this really nurbs? well maybe. Probably stuff the Peters' Scheme fitting in here and remove some other parts}
...
\todo[inline]{insert stuff here, what's described in Peters' Scheme, will see where it fits}