...
\todourgent[inline,author=Anna]{this section goes away, we explain this in 'Fitting Problem: Parametric Surfaces' anyway. Just give some Least Squares refs there.}
