...
\todointern[inline]{Erik: define section}

\subsection{Fitting problem}
\todointern[inline]{is this really nurbs? well maybe. Probably stuff the Peters' Scheme fitting in here and remove some other parts}
...
\todourgent[inline]{why (least squares) here and not above? is this consistent?}
