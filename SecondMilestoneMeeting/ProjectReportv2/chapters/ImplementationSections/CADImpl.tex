\section{From a \acs{CAD} model to Voxels}
\todourgent[inline]{combine 3.1 and 3.2 into one part like in the discussion section? This section is much more than the voxelization, but also preprocessing for topy. And the topy section is quite short.}
