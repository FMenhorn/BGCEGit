...
public:
    ...
    bool write(std::string _filename, std::vector<Voxel_BoolDS> &voxelShape);
...
private:
    ...
    void writeNodes(std::string name, std::ofstream &outfile, Voxel_BoolDS &voxelShape, std::vector<int> dimensions); //later change to vector of shapes
