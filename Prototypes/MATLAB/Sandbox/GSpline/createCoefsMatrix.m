...
% takes parameterCoordinates[Nx2](on a patch that spans over [0,1] with
% domainMxdomainN
% local bezier patches) and computes the coefficient matrix for each of
% these as a Nx (domainM +2) x (domainN + 2) matrix (where the first and last columns/rows are the
% neighbouring points)
