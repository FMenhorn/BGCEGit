...
minorRads = (1+0.3.*cos(2*pi*6.*torParams)).*(2 + 0.1*rand(numPoints,1));
majorRadis = 9.*(1+0.3.*sin(2*pi*3.*torParams));
...
torPerturbations = 1 + 0.01.*sin(torParams*2*pi);
polPerturbations = 1 + 0.01.*sin(polParams*2*pi);
