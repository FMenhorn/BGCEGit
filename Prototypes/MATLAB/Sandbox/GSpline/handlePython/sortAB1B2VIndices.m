function [newA,newB1,newB2,newC] = sortAB1B2VIndices(oldA,oldB1,oldB2,oldC)
...
for i = 1:size(oldB2,1)
    ...
    for local_quad_index = 1:m
        ...
        neighbourAIndex = find(oldA(i,1:m,2) == neighbourQuad);
        neighbourB2Index = find(oldB2(i,1:m,2) == neighbourQuad);
        neighbourCIndex = find(oldC(i,1:m,2) == neighbourQuad);
