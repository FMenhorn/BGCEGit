function plotHandle = plotBezierSurfaceWhole(quad_list,AVertexList,B1VertexList,B2VertexList,CVertexList,quad_control_point_indices,control_points)
...
plotHandle = figure('Name', 'Bezier surface plot');
hold on;
