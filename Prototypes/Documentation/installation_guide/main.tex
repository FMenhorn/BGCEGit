...
\begin{document}
	...
	\label{intro}
	In this document we provide a complete guide on how to install and use CADO tool on Linux.
...
\end{lstlisting}	
After that open \textbf{QtCreator} and load the \textit{GUI.pro} file from the \textit{"CADO/GUI"} folder into the framework and run the program using the \textbf{"Run"} button.
